<p align="center">
  <img src="./assets/profile-header.svg" width="100%" alt="Hey, I'm Sadad! AI, full-stack, and a few side quests." />
</p>

<p align="center">
  <strong>Adnan Mashrur Sadad · AI & Software Engineer · Kuala Lumpur 🇲🇾</strong><br />
...
<a href="https://github.com/sadad54?tab=repositories"><img src="./assets/github-stats.svg" width="100%" alt="Public repository count and primary-language mix. Updated daily; full numbers in the expandable section below." /></a>

<details>
<summary>Numbers, minus the graphics</summary>

<!-- STATS:START -->
Updated **2026-09-25** · **38 public repositories** · **7 primary languages**.
...
<img src="./assets/toolkit.svg" width="100%" alt="Python, TypeScript, React, Next.js, FastAPI, PostgreSQL, Redis, PyTorch, XGBoost, Docker, Flutter, and GitHub Actions" />

<details>
<summary>A little background + résumés</summary>
...
<p align="center"><sub>Build something useful. Make it feel good to use. Find out where it breaks. Repeat. ✦</sub></p>
